...
const Sidebar = () => {
  ...
  const ActiveComponent =
    componentMap[activeMenu] || (() => <div>Select a menu</div>);
    ...
    <>
      ...
      <div className="md:hidden fixed top-4 left-4 z-50 cursor-pointer">
        <button
          ...
          className="bg-[#201F1F] p-2 rounded-full cursor-pointer"
        >
      ...
      >
        ...
        <div
          ...
          className="w-[290px] h-full p-5 flex flex-col justify-start shadow-lg transition-colors duration-300"
        >
          {/* Header */}
